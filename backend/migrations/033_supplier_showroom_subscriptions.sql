-- Supplier showroom subscriptions and canonical ownership
...
CREATE TABLE IF NOT EXISTS showroom_subscription_settings (
  ...
  monthly_price NUMERIC(14,2) NOT NULL DEFAULT 10
    CHECK (monthly_price >= 0),
  annual_price NUMERIC(14,2) NOT NULL DEFAULT 100
...
CREATE INDEX IF NOT EXISTS idx_showroom_subscriptions_showroom
  ON showroom_subscriptions(showroom_id, created_at DESC);
...
ALTER TABLE payments
  ...
  CHECK (
    ...
    OR advertisement_id IS NOT NULL
