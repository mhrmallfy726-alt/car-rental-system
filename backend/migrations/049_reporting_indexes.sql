...
-- Safe to run through the normal migration runner.
...
CREATE INDEX IF NOT EXISTS idx_reservations_status_created_at ON reservations (status, created_at);
CREATE INDEX IF NOT EXISTS idx_reservations_supplier_created_at ON reservations (supplier_id, created_at);
CREATE INDEX IF NOT EXISTS idx_reservations_car_created_at ON reservations (car_id, created_at);
