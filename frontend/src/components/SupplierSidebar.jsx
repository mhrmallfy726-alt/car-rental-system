...
export default function SupplierSidebar() {
  ...
  const visibleLinks = (isBranch ? supplierLinks.filter(({ to }) => ['/supplier/dashboard', '/supplier/cars', '/supplier/cars/add', '/supplier/reservations', '/supplier/employees', '/supplier/advertisement-request', '/supplier/settings'].includes(to)) : supplierLinks).map((link) => isBranch && link.to === '/supplier/settings' ? { ...link, to: '/supplier/branch-settings' } : link);
