  ...
  return <main dir="rtl" style={styles.page}><div style={styles.wrap}>
    ...
    <div style={styles.layout}>
      ...
      <section style={styles.content}>
        {active === 'overview' ? <Overview role={role} RoleIcon={RoleIcon} cards={cards} overview={overview} setActive={setActive} sections={sections} /> : <Department section={active} rows={rows} loading={sectionLoading} permissions={permissionNames} />}
      </section>
    </div>
  </div></main>;
}
