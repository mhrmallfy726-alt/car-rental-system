        ...
        <div style={{ position: 'relative', zIndex: 2, maxWidth: '1200px', margin: '0 auto', padding: '0 20px', width: '100%' }}>
          <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: '60px' }}>
            ...
            <div style={{ flex: '1 1 500px', textAlign: 'right' }}>
              ...
              <div className="hero-original-actions"><Link to="/search" className="hero-original-primary">استكشف السيارات <ArrowLeft size={20} /></Link><Link to="/marketing" className="hero-original-secondary">سجّل كمعرض <Building2 size={20} /></Link></div>
