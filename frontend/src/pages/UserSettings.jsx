...
export default function UserSettings() {
  ...
  return (
    <main dir="rtl" className="user-settings-page" style={{ minHeight: '100vh', background: soft, padding: '28px 20px', color: navy }}>
      <div className="user-settings-container" style={{ maxWidth: 1180, margin: '0 auto' }}>
        <header className="user-settings-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 18, marginBottom: 24 }}>
        ...
        <div className="user-settings-layout" style={{ display: 'grid', gridTemplateColumns: '250px minmax(0, 1fr)', gap: 20, alignItems: 'start' }}>
          <aside className="user-settings-tabs" style={{ background: '#fff', border: '1px solid #e3eeee', borderRadius: 18, padding: 10, position: 'sticky', top: 20 }}>
          ...
          <section className="user-settings-panels" style={{ display: 'grid', gap: 18 }}>
      ...
      <style>{`
        @media(max-width:760px){
          .user-settings-page{padding:88px 14px 24px!important}
          .user-settings-header{align-items:flex-start!important;gap:12px!important;flex-wrap:wrap!important}
          .user-settings-header h1{font-size:24px!important}
          .user-settings-layout{grid-template-columns:1fr!important}
          .user-settings-tabs{position:static!important;display:flex!important;align-items:stretch;gap:5px;overflow-x:auto;scrollbar-width:none;-webkit-overflow-scrolling:touch;padding:7px!important}
          .user-settings-tabs::-webkit-scrollbar{display:none}
          .user-settings-tabs button{flex:0 0 auto!important;width:auto!important;white-space:nowrap;margin:0!important;padding:10px 12px!important}
          .user-settings-tabs>div{display:none!important}
          .user-settings-form-grid{grid-template-columns:1fr!important}
          .user-settings-panels{min-width:0}
        }
        @media(max-width:520px){
          .user-settings-page{padding-inline:10px!important}
          .user-settings-header h1{font-size:22px!important}
          .user-settings-header>div:last-child{width:44px!important;height:44px!important;border-radius:13px!important}
          .user-settings-panels>div{padding:16px!important;border-radius:15px!important}
          .user-settings-panels img{max-width:76px}
          .user-settings-panels button{max-width:100%}
        }
      `}</style>
    </main>
  );
