...
import BranchFirstLogin from './pages/auth/BranchFirstLogin';
...
import BranchSettings from './pages/supplier/BranchSettings';
...
export default function App() {
  return <><Toaster position="top-right" toastOptions={{ style: { background: '#1a1a2e', color: '#f1f5f9', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '12px' }, duration: 4000 }} /><Navbar /><div className="rc-app-shell" onChangeCapture={handleInputChangeCapture} onSubmitCapture={handleSubmitCapture}><Routes>
    <Route path="/" element={<Landing />} /><Route path="/home" element={<Navigate to="/" replace />} /><Route path="/about" element={<About />} /><Route path="/marketing" element={<MarketingChoice />} /><Route path="/MarketingChoice" element={<Navigate to="/marketing" replace />} /><Route path="/login" element={<Login />} /><Route path="/branch-first-login" element={<BranchFirstLogin />} /><Route path="/forgot-password" element={<ForgotPassword />} /><Route path="/register" element={<Register />} /><Route path="/supplier/join" element={<VendorJoin />} /> <Route path="/policies" element={<Policies />} /><Route path="/terms" element={<Navigate to="/policies#terms" replace />} /><Route path="/privacy" element={<Navigate to="/policies#privacy" replace />} /><Route path="/supplier-terms" element={<Navigate to="/policies#supplier" replace />} /><Route path="/rental-policy" element={<Navigate to="/policies#rental" replace />} /><Route path="/Vendor-Join" element={<Navigate to="/supplier/join" replace />} /><Route path="/search" element={<SearchPage />} /><Route path="/cars" element={<SearchRequiredRoute><Cars /></SearchRequiredRoute>} /><Route path="/cars/:id" element={<CarDetail />} /><Route path="/car/:id" element={<LegacyCarRedirect />} /><Route path="/supplier-benefits" element={<MarketingRole role="supplier" />} /><Route path="/renter-benefits" element={<MarketingRole role="renter" />} /><Route path="/profile" element={<PrivateRoute><Profile /></PrivateRoute>} /><Route path="/settings" element={<PrivateRoute><UserSettings /></PrivateRoute>} /><Route path="/complaints/:id" element={<PrivateRoute><ComplaintChat /></PrivateRoute>} /><Route path="/notifications" element={<PrivateRoute><Notifications /></PrivateRoute>} /><Route path="/notifications/:id" element={<PrivateRoute><NotificationDetail /></PrivateRoute>} />
    <Route path="/employee/dashboard" element={<PrivateRoute roles={['employee']}><EmployeeWorkspace /></PrivateRoute>} />
    ...
    <Route path="/supplier/dashboard" element={<PrivateRoute roles={['supplier']}><SupplierDashboard /></PrivateRoute>} /><Route path="/supplier/cars" element={<PrivateRoute roles={['supplier']}><MyCars /></PrivateRoute>} /><Route path="/supplier/cars/add" element={<PrivateRoute roles={['supplier']}><AddCar /></PrivateRoute>} /><Route path="/supplier/cars/edit/:id" element={<PrivateRoute roles={['supplier']}><EditCar /></PrivateRoute>} /><Route path="/supplier/reservations" element={<PrivateRoute roles={['supplier']}><SupplierReservations /></PrivateRoute>} /><Route path="/supplier/reservations/:id" element={<PrivateRoute roles={['supplier']}><SupplierReservationDetail /></PrivateRoute>} /><Route path="/supplier/finance" element={<PrivateRoute roles={['supplier']}><SupplierFinance /></PrivateRoute>} /><Route path="/supplier/settings" element={<PrivateRoute roles={['supplier']}><SupplierSettings /></PrivateRoute>} /><Route path="/supplier/branch-settings" element={<PrivateRoute roles={['supplier']}><BranchSettings /></PrivateRoute>} />
    <Route path="/supplier/login" element={<Login />} /><Route path="/supplier/employees/:id" element={<PrivateRoute roles={['supplier']}><EmployeeDetail /></PrivateRoute>} /><Route path="/supplier/employees/new" element={<PrivateRoute roles={['supplier']}><EmployeeForm /></PrivateRoute>} /><Route path="/supplier/advertisement-request" element={<PrivateRoute roles={['supplier']}><AdvertisementRequest /></PrivateRoute>} /><Route path="/supplier/employees" element={<PrivateRoute roles={['supplier']}><EmployeeList /></PrivateRoute>} /><Route path="/supplier/showrooms" element={<Showrooms />} /><Route path="/pages/supplier/employees/:id" element={<LegacyEmployeeRedirect />} /><Route path="/supplier/EmployeeForm" element={<Navigate to="/supplier/employees/new" replace />} /><Route path="/supplier/AdvertisementRequest" element={<Navigate to="/supplier/advertisement-request" replace />} /><Route path="/supplier/EmployeeList" element={<Navigate to="/supplier/employees" replace />} />
    <Route path="/admin/dashboard" element={<PrivateRoute roles={['admin']}><AdminDashboard /></PrivateRoute>} /><Route path="/admin/reports" element={<PrivateRoute roles={['admin']}><Reports /></PrivateRoute>} /><Route path="/admin/users" element={<PrivateRoute roles={['admin']}><AdminUsers /></PrivateRoute>} /><Route path="/admin/complaints" element={<PrivateRoute roles={['admin']}><AdminComplaints /></PrivateRoute>} /><Route path="/admin/branch-requests" element={<PrivateRoute roles={['admin']}><BranchRequests /></PrivateRoute>} /><Route path="/admin/advertisement-center" element={<PrivateRoute roles={['admin']}><Adminadvertisement /></PrivateRoute>} /><Route path="/admin/advertisements" element={<Navigate to="/admin/advertisement-center" replace />} /><Route path="/admin/advertisementCenter" element={<Navigate to="/admin/advertisement-center" replace />} /><Route path="/admin/cars" element={<PrivateRoute roles={['admin']}><AdminCars /></PrivateRoute>} /><Route path="/admin/cars/:id" element={<PrivateRoute roles={['admin']}><AdminCarDetail /></PrivateRoute>} /><Route path="/admin/finance" element={<PrivateRoute roles={['admin']}><FinanceCenter /></PrivateRoute>} /><Route path="/admin/settings" element={<PrivateRoute roles={['admin']}><AdminSettings /></PrivateRoute>} /><Route path="/admin/supplier-requests" element={<PrivateRoute roles={['admin']}><SupplierRequests /></PrivateRoute>} /><Route path="*" element={<Navigate to="/" replace />} />
  </Routes></div></>;
}
